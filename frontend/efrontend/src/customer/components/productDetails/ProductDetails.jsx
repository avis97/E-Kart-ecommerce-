    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div
            className="lg:col-span-1 max-auto 
          max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8
          lg:pb-24"
          >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">454 Rating</p>
                  <p
          ...
          <div className="border p-5">
            <Grid container spacing={7}>
              ...
              <Grid className="mt-11">
                ...
                <div className="flex items-center space-x-3">
                  <Rating value={4.6} precision={0.5}></Rating>
                  <p className="opacity-60">44 rating</p>
                </div>
                <Box className="mt-7">
                  <Grid container alignItems="center" gap={2}>
                      ...
                      <Grid item xs={7}>
                        <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,height:7 ,width:250 ,marginLeft:5}} variant="determinate" value={40} color="success"/>
                      </Grid>
                  </Grid>
                  <Grid container alignItems="center" gap={2}>
                      <Grid item xs={2}>
        ...
        <section className="pt-10">
         ...
         <div className="flex flex-wrap space-y-5">
          {[1,1,1,1].map((item)=><HomeSectionCard/>)}
         </div>
        </section>
      </div>
    </div>
